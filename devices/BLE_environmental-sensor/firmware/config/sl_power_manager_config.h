...
// function sl_power_manager_irq_handler() will have to be called from your
...
// <q SL_POWER_MANAGER_ENABLE_EM01_VOLTAGE_SCALING> Enable voltage scaling in
// EM0 and EM1 mode. <i> Enable or disable voltage scaling in EM0/1 modes. With
// this config enabled, the voltage <i> scaling will be configured at the lowest
// possible level based on the system clock. <i> Default: 0
...
#define SL_POWER_MANAGER_DEBUG_POOL_SIZE 40
#endif
// </e>
...
// <i> Force PD0B/PD0D to stay on during EM2 entry. This allows the debugger to
// remain connected in EM2 and EM3. <i> Enabling debug connectivity results in
// an increased power consumption in EM2/EM3. <i> Default: 1
