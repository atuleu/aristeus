...
{
  0x1d, 0xfc, 0x39, 0x1a, 0x3c, 0xc2, 0x99, 0xb6, 0x3a, 0x45, 0x02, 0x5c, 0x7d, 0x7d, 0x02, 0x48, 
  0x54, 0x17, 0xae, 0x89, 0x51, 0xb3, 0x72, 0xb8, 0x15, 0x46, 0x01, 0xe9, 0x19, 0xcd, 0x6d, 0x38, 
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0x19, 0xe0, 0xcc, 0xf3, 0x7e, 0xb6, 0x7e, 0xb2, 0x82, 0x48, 0xd5, 0xb5, 0x7c, 0x77, 0xf3, 0x63, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_21) = {
  ...
  .max_len = 10,
  .len = 5,
  .data = { 0x30, 0x2e, 0x30, 0x2e, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_15) = {
  .len = 11,
  .data = { 0x4c, 0x69, 0x62, 0x65, 0x72, 0x74, 0x69, 0x20, 0x4c, 0x61, 0x62, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 10,
  .data = { 0x45, 0x6e, 0x76, 0x20, 0x53, 0x65, 0x6e, 0x73, 0x6f, 0x72, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1a, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x28, .char_uuid = 0x000a } },
  { .handle = 0x1b, .uuid = 0x000a, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_26 },
  ...
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x10, .char_uuid = 0x8000 } },
  { .handle = 0x1e, .uuid = 0x8000, .permissions = 0x800, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_29 },
  ...
  { .handle = 0x20, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8001 } },
  { .handle = 0x21, .uuid = 0x8001, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_32 },
};
