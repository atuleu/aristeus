...
if (TOOLCHAIN_SLT_PATH)
  ...
  set(DEFAULT_TOOLCHAIN_DIR "${USER_DIR}/.silabs/slt/installs/conan/p/gcc-a469753773d4f2/p/bin/")
endif ()
...
if (COMMANDER_SLT_PATH)
  ...
  set(DEFAULT_POST_BUILD_EXE "${USER_DIR}/.silabs/slt/installs/archive/commander/commander")
endif ()

if (NINJA_SLT_PATH)
  set(DEFAULT_NINJA_RUNTIME_PATH "${NINJA_SLT_PATH}/ninja")
else()
  set(DEFAULT_NINJA_RUNTIME_PATH "${USER_DIR}/.silabs/slt/installs/conan/p/ninja1b9fed093d653/p/ninja")
endif ()
